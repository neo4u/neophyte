...
# Time: O(n)
# This is controversial while there are two nested loops but.
# Each element is pushed and popped only once. so the nested loops only result in O(2 * n) in the worst case.
# Space: O(n)
