...
#    in the sliding window, in order to find the longest substring T,
#    we need to locate the smallest location, and remove it from the dictionary,
#    and then record the return value.

# Solve this list of all sliding window problems
