...
#     - first insert the num in max_heap
#     - Then take the top of max_heap and insert in min_heap
#     - If at any point len(max_heap) < len(min_heap) then, pop from min_heap and insert into max_heap
#     - This ensure that max_heap is always equal or 1 element greater in size then min_heap
# 5. For findMedian:
