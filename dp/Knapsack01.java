...
// dp [i][j]: Max value that can be obtained from items 0 to i - 1. With weight limit j
// dp[0][j] = 0, limit j value 0
// dp[i][0] = 0, value i but limit 0
...
public class Knapsack01 {
    ...
    public int topDownRecursiveUtil(int values[], int weights[], int remainingWeight, int totalItems, int currentItem,
        ...
        // see if key exists in map. If so then return the maximumValue for key stored
        // in map.
